...
/**
 * Represents a simple shopping cart that allows adding items, applying discount
 * codes, and calculating the total cost.
 */
public class ShoppingCart {
	...
	/**
	 * Calculates and returns the total cost of the cart, applying any discounts
	 * currently in effect.
	 * 
	...
	/**
	 * Applies a valid discount code to the shopping cart. Supported codes: -
	 * "SAVE10": 10% discount - "SAVE20": 20% discount
	 * 
	...
	/**
	 * Returns the current discount percentage applied to the cart. Useful for
	 * testing.
	 * 
